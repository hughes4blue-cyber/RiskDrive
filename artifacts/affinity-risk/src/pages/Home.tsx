...
import {
  HardHat, BarChart3, Bot, ArrowRight, Shield,
  AlertTriangle, CheckCircle2, Clock, Users, Car, Scale,
  ChevronRight, FileText, Satellite, Zap, Lock
} from "lucide-react";
  ...
  return (
    <div className="min-h-full">
      ...
      <section
        ...
        style={{ background: "linear-gradient(135deg, #0F2940 0%, #0D3D56 60%, #0A4D6B 100%)" }}
      >
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-10">
            ...
            <div className="flex-1 space-y-5">
              ...
              <p className="text-slate-300 text-lg leading-relaxed max-w-xl">
                AmTrust's dedicated towing contractor program — rated on actual payroll by class code,
                through <strong className="text-white">AmTrust exclusively</strong>, with 24-hour quote turnaround.
              </p>

              {/* Single primary CTA + clearly secondary link */}
              <div className="flex flex-wrap items-center gap-4 pt-1">
                <Link
                  href="/wc-quote"
                  className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl font-bold text-sm text-white shadow-lg transition-all hover:scale-105 hover:shadow-xl"
      ...
      <section className="bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-6 py-8">
          <div className="text-center mb-6">
            <div className="text-[10px] font-bold uppercase tracking-widest text-orange-500 mb-1">How It Works</div>
            <h2 className="text-lg font-extrabold text-slate-900">From telematics data to lower premiums — in three steps</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                icon: Shield,
                step: "03",
                title: "Bind better coverage",
                desc: "Your telematics data pre-fills the AmTrust WC application. Carriers compete for your business. Average network savings: 14% vs. benchmark.",
                accent: "#059669",
                href: "/wc-quote",
              },
            ].map(({ icon: Icon, step, title, desc, accent, href }) => (
              <Link
                key={step}
                href={href}
                className="group relative bg-slate-50 rounded-2xl p-6 border border-slate-200 hover:border-slate-300 hover:shadow-md transition-all"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-bold text-slate-900 mb-1.5">{title}</div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div
                ...
                style={{ background: "linear-gradient(135deg,#0F2940,#0D3D56)" }}
              >
            ...
            <Link href="/wc-quote" className="text-xs font-semibold text-orange-500 hover:text-orange-600 flex items-center gap-1">
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <p className="text-sm text-slate-600 leading-relaxed">
                AmTrust's dedicated towing contractor program — payroll and class-code rated. After binding,
                your WC data <strong>preloads directly into your telematics platform</strong> via API.
              </p>
              <div className="space-y-2.5">
                {[
                  ...
                  { icon: Lock, text: "AmTrust dedicated program — competitive towing-specific rates", color: "text-orange-500" },
            ...
            <div className="bg-slate-50 rounded-xl p-4 space-y-3">
              ...
              {[
                ...
                <div key={c.code} className="flex items-center justify-between py-1 border-b border-slate-200 last:border-0">
                  ...
                  <span className="text-xs font-bold text-emerald-700">${c.rate.toFixed(2)}/$100</span>
                </div>
              ))}
        ...
        <div className="rounded-2xl overflow-hidden shadow-sm border border-slate-200 bg-white flex flex-col">
          <div
            className="px-5 py-4 border-b border-slate-100 flex items-center gap-2.5"
            style={{ background: "linear-gradient(135deg,#E97132,#C85A1F)" }}
          >
          ...
          {[
            ...
            >
              ...
              <div className="min-w-0">
                <div className="text-sm font-semibold text-slate-800 group-hover:text-orange-600 transition-colors">{label}</div>
        ...
        <div className="lg:col-span-3 bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
            ...
            <Link href="/accidents" className="text-xs text-orange-500 hover:text-orange-600 font-medium flex items-center gap-1">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {item.urgent && (
                      <span className="text-[10px] bg-red-100 text-red-600 px-1.5 py-0.5 rounded-full font-semibold">Action needed</span>
                    )}
                  </div>
