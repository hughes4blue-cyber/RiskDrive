      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
          ...
          <div className="grid grid-cols-3 gap-4 text-xs text-blue-700">
            ...
            <div className="flex items-start gap-2"><span className="w-5 h-5 rounded-full bg-blue-600 text-white text-[10px] flex items-center justify-center flex-shrink-0 mt-0.5">3</span><span>Net payout is disbursed to the hauler — FleetLytics provides a full audit trail per period</span></div>
          </div>
        </div>
