    ...
    <div>
      ...
      <div className="p-6 space-y-5">
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-lg px-4 py-3 text-xs text-blue-800 flex items-center gap-3">
          ...
          <span>FleetLytics analyzes telematics events in real time and sends in-cab or mobile alerts to drivers within seconds of a detected behavior. Alerts are logged here for fleet manager review and acknowledgement.</span>
        </div>
