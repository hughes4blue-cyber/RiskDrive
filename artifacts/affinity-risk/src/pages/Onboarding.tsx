...
const CHECKLIST_ITEMS: { key: keyof Checklist; label: string; description: string; category: string }[] = [
  ...
  { key: "telematicsDeviceInstalled", label: "Telematics Device Installed", description: "FleetLytics-compatible device installed in all vehicles", category: "Telematics" },
];
